...
'Intelligent shallow merge for top-level object updates. Simplifies incremental view maintenance logic.';
...
'Merge JSONB at nested path within document. Array-based path specification for flexible updates.';
...
'Update specific element within JSONB array. Combines search and update in single operation.';
...
'Surgical array element deletion. 5-7× faster than re-aggregation approaches.';
...
'Insert element into JSONB array with optional sorting. Maintains order during incremental updates.';
...
'Recursive deep merge for complex nested updates. Preserves existing structure while updating changed fields.';
...
'Extract ID values from JSONB objects. Defaults to "id" key for convenience.';
...
'Fast existence checking for array elements. Optimized for view maintenance workflows.';