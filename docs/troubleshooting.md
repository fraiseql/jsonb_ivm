...
**Expected output:**
```
/usr/lib/postgresql/17/lib/jsonb_ivm.so
/usr/share/postgresql/17/extension/jsonb_ivm.control
/usr/share/postgresql/17/extension/jsonb_ivm--0.3.0.sql
/usr/share/postgresql/17/extension/jsonb_ivm--0.2.0--0.3.0.sql
```
